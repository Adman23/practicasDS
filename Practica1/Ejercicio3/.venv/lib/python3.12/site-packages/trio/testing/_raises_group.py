...
class AbstractMatcher(ABC, Generic[BaseExcT_co]):
    ...
    def matches(
        ...
        """Check if an exception matches the requirements.txt of this AbstractMatcher.
...
class Matcher(AbstractMatcher[MatchE]):
    """Helper class to be used together with RaisesGroups when you want to specify requirements.txt on sub-exceptions. Only specifying the type is redundant, and it's also unnecessary when the type is a nested `RaisesGroup` since it supports the same arguments.
    ...
    def matches(
        ...
        """Check if an exception matches the requirements.txt of this Matcher.
...
class RaisesGroup(AbstractMatcher[BaseExceptionGroup[BaseExcT_co]]):
    ...
    def matches(
        ...
        """Check if an exception matches the requirements.txt of this RaisesGroup.
